...
public interface shareHolderClient {
    ...
    Call<List<checkAuthorityForVoteAllResponse>> checkAuthorityForVoteAll(@Path("delegate_Id") String delegate_id);
    ...
    Call<List<agendaForClientResponse>> getAgenda(@Path("agendaId") String agendaId);

    @GET("/checkAuthorityForVote/{agendaId}/{delegate_ID}")
    Call<List<checkAuthorityForVoteAgendaResponse>> checkAuthorityForVote(@Path("agendaId")int agendaId, @Path("delegate_ID") String delegate_ID);
